  ...
  async getEarliestDirectFlight(origin, destination, minDepartureTime) {
    try {
      ...
      for (const flight of flights) {
        ...
        // Skip flights with more than one segment
      ...
      validFlights.sort((a, b) =>
        moment.utc(a.flight.itineraries[0].segments[0].departure.at).diff(
          moment.utc(b.flight.itineraries[0].segments[0].departure.at)
        )
      );
